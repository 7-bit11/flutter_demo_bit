...
import 'package:study_demo/pages/QQ/model/user_send_user_msg_model.dart';
import 'package:study_demo/pages/QQ/widget/serach_field.dart';
...
class _MessageDetailsPageState extends State<MessageDetailsPage> {
  ...
  Widget item(UserSendUserMsgModel userMsgModel, double width) {
